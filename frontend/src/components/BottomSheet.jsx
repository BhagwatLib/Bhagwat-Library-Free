...
export const BottomSheet = ({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center p-0 md:p-4 bg-black/75 backdrop-blur-md modal-backdrop-container">
          ...
          >
            ...
            <div className="p-5 md:p-6 overflow-y-auto custom-scrollbar flex-1 space-y-4 pb-8 modal-scrollable-content">
              {children}
            </div>
          </motion.div>
        </div>
