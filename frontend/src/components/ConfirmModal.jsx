...
export const ConfirmModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/75 backdrop-blur-md animate-in fade-in duration-200 modal-backdrop-container">
      <div className="skeuo-card w-full max-w-sm p-6 shadow-2xl animate-in zoom-in-95 duration-200 modal-scrollable-content">
