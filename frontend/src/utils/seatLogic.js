// Realtime Seat & Shift Business Logic Utility (A, B, C, D & All Shift)

export const BASE_SLOTS = [
  { id: "a", slotCode: "A", name: "A Shift", time: "6:00 AM - 10:00 AM", label: "A Shift (6:00 AM - 10:00 AM)", key: "slot1" },
  { id: "b", slotCode: "B", name: "B Shift", time: "10:00 AM - 2:00 PM", label: "B Shift (10:00 AM - 2:00 PM)", key: "slot2" },
  { id: "c", slotCode: "C", name: "C Shift", time: "2:00 PM - 6:00 PM", label: "C Shift (2:00 PM - 6:00 PM)", key: "slot3" },
  { id: "d", slotCode: "D", name: "D Shift", time: "6:00 PM - 10:00 PM", label: "D Shift (6:00 PM - 10:00 PM)", key: "slot4" },
];
...
export const getSlotsFromBatch = (batchInput) => {
  ...
  batches.forEach((b) => {
    ...
    if (str.includes("ALL") || str.includes("6:00 AM - 10:00 PM") || str.includes("6AM-10PM") || str.includes("FULL DAY")) {
      slotsSet.add("a");
      slotsSet.add("b");
      slotsSet.add("c");
      slotsSet.add("d");
    } else if (str === "A" || str.includes("A SHIFT") || str.includes("A BATCH") || str.includes("6:00 AM - 10:00 AM") || str.includes("6AM-10AM")) {
      slotsSet.add("a");
    } else if (str === "B" || str.includes("B SHIFT") || str.includes("B BATCH") || str.includes("10:00 AM - 2:00 PM") || str.includes("10AM-2PM")) {
      slotsSet.add("b");
    } else if (str === "C" || str.includes("C SHIFT") || str.includes("C BATCH") || str.includes("2:00 PM - 6:00 PM") || str.includes("2PM-6PM")) {
      slotsSet.add("c");
    } else if (str === "D" || str.includes("D SHIFT") || str.includes("D BATCH") || str.includes("6:00 PM - 10:00 PM") || str.includes("6PM-10PM")) {
      slotsSet.add("d");
    }
  });
